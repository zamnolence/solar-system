...
Revision ID: 821085db7628
Revises: d63717527b10
Create Date: 2021-05-11 23:07:53.869817
...
revision = '821085db7628'
down_revision = 'd63717527b10'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('moduleset_id', sa.Integer(), nullable=True),
    sa.Column('question_number', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['moduleset_id'], ['moduleset.id'], ),
